...
if __name__ == "__main__":
    ...
    file_out = f"./qaoa_data/qaoa_circ_params_max_power_{max_pow}_transpile_level_{level}.csv"
    ...
    for m in biprimes:
        ...
        params = [1, 1] # a typical QAOA ansatz has two parameters, we set them to be ones.
    ...
    with open(file_out, 'w') as csvfile:
        ...
        csvwriter.writerow(["biprime", "n_qubits", "depth", "n_gates", "n_cnot","n_u3"])
